...
@Component({
    selector: 'app-register-property-rent-form',
    standalone: false,
    template: `
        @let pending = $pending();
        @let fieldErrors = $fieldErrors();

        <h2 class="mt-0 text-base text-slate-500">Datos de la renta</h2>
...
export class RegisterPropertyRentFormComponent {
    ...
    public form: FormGroup = (this._properties.formsBuffer['registerProperty']['datos_renta'] as FormBuffer).form;
